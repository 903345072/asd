        ...
        <form name="Form1" class="form form-horizontal" action="?key=<?php echo $key;?>" method="post" id="Form1" onsubmit="return chkForm()">
            <div class="row cl">
                ...
                <div class="formControls col-xs-8">
                    ...
                    <input placeholder="输入管理账号" id="username" name="name" class="input-text size-L" type="text"/>
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60e;</i></label>
                <div class="formControls col-xs-8">
                    ...
                    <input placeholder="输入管理密码" type="password" id="pwd" name="password" class="input-text size-L"/>
                </div>
            </div>
