...
<html>
  ...
  <body>
    <nav class="breadcrumb">
      ...
      <span class="c-gray en">&gt;</span> 城市管理
      <span class="c-gray en">&gt;</span> 新增城市
      <a
    ...
    <div class="page-container">
      <form
        ...
        action="<?php echo U('save');?>"
        method="post"
        onsubmit="return ac_from();"
      ...
      >
        ...
        <div class="row cl">
          <label class="form-label col-xs-4 col-sm-3"
            ><span class="c-red">*</span>城市名称：</label
          >
          <div class="formControls col-xs-8 col-sm-3">
            <input
              type="text"
        ...
        <div class="row cl">
          <label class="form-label col-xs-4 col-sm-3"
            ><span class="c-red">*</span>排 序：</label
          >
          <div class="formControls col-xs-8 col-sm-3">
            <input
              type="text"
        ...
        <div class="row cl">
          <label class="form-label col-xs-4 col-sm-3"
            ><span class="c-red">*</span>是否启用：</label
          >
          <div class="formControls col-xs-8 col-sm-3">
            <input type="radio" name="is_status" value="1"
            <?php echo $cate_info[ 'is_status']==1 ? 'checked="checked"' : null?>/>
            是 &nbsp; <input type="radio" name="is_status" value="0"
            <?php echo $cate_info[ 'is_status']!=1 ? 'checked="checked"' : null?>
            /> 否
          </div>
        </div>
