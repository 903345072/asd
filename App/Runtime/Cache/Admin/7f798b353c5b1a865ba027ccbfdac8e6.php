...
<div class="page-container">
    <form class="form form-horizontal" action="?id=<?php echo ($id); ?>&page=<?php echo ($page); ?>&type=<?php echo ($type); ?>&name=<?php echo ($name); ?>" method="post" onsubmit="return ac_from();" enctype="multipart/form-data">
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-3">
                <input type="text" class="input-text" placeholder="广告语" name="intro" id="intro" value="<?php echo ($pro_allinfo["intro"]); ?>">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-3">
                <select class="inp_1" name="city_id" id="city_id" style="width:150px;margin-right:5px;">
                    ...
                    <?php if(is_array($city_list)): $i = 0; $__LIST__ = $city_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>" <?php if($v["id"] == $pro_allinfo['city_id']): ?>selected="selected"<?php endif; ?>>-- <?php echo ($v["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    <!-- 遍历 -->
                </select>
                <br>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-3">
                <select class="inp_1" name="shop_id" id="shop_id" style="width:150px;margin-right:5px;">
                    <!-- 遍历 -->
                    <option value="">选择商户</option>
                    <?php if(is_array($business)): $i = 0; $__LIST__ = $business;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>" <?php if($v["id"] == $pro_allinfo['shop_id']): ?>selected="selected"<?php endif; ?>>-- <?php echo ($v["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                    <!-- 遍历 -->
                </select>
                <br>
        ...
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>返佣：</label>
            <div class="formControls col-xs-8 col-sm-3">
                <input type="text" class="input-text" placeholder="返佣" name="price_jf" id="price_jf" value="<?php echo ($pro_allinfo["price_jf"]); ?>">
            </div>
        </div>
        <!-- <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-3">
                <select class="inp_1" name="is_activity" id="is_activity" style="width:150px;margin-right:5px;">
                    <!-- 遍历 -->
                    <option value="0">不参与活动</option>
                    <?php if(is_array($activity_list)): $i = 0; $__LIST__ = $activity_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$a): $mod = ($i % 2 );++$i;?><option value="<?php echo ($a["id"]); ?>" <?php if($a["id"] == $pro_allinfo['is_activity']): ?>selected="selected"<?php endif; ?>>-- <?php echo ($a["name"]); ?>
